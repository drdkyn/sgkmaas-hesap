...
const OUT = {
  ...
  primGunSayisi: 'Emeklilik Şartları!J14',     // mevcut prim ödeme gün (çakışma düşülmüş net)
  sigortalilikSuresi: 'Emeklilik Şartları!K8',
  cakisanHizmet: 'Kontrol!C12',                // SUM(Hiz.Dökümü!AZ) — aynı ay çakışan/düşülen gün (negatif)
};
